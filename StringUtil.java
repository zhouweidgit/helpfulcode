...
public class StringUtil {
	...
	public static boolean isMobile(String mobile) {
		...
		if (mobile.startsWith("13") || mobile.startsWith("14") || mobile.startsWith("15")
			|| mobile.startsWith("18") || mobile.startsWith("17")) {
			return true;
		}
		return false;
	 ...
	 * 
	 * <pre>
     * StringUtil.mask(null)    = null
     * StringUtil.mask("")      = ""
     * StringUtil.mask("1")     = "*"
     * StringUtil.mask("11")   = "*1"
     * StringUtil.mask("111")   = "1*1"
     * StringUtil.mask("1111")   = "1**1"
     * StringUtil.mask("11111")   = "1**11"
     * StringUtil.mask("111111")  = "1***11"
     * StringUtil.mask("11111111111")  = "111*****111"
     * </pre>
	 *
	 * @param str
	 * @return
     ...
     * StringUtil.equals(null, "abc")  = true
     * StringUtil.equals("abc", null)  = true
     * StringUtil.equals("abc", "abc") = false
     * StringUtil.equals("abc", "ABC") = true
     * </pre>
	 *
